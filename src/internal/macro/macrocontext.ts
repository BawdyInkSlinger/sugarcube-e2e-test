...
export const MacroContext = (() => {
  ...
  class MacroContext {
    ...
    declare _debugViewEnabled: boolean;
    declare _shadows: any;
    declare _output: any;
    ...
    declare payload: {
      name: string;
      args: string[] & { full: string; raw: string };
      source: typeof MacroContext.prototype.source;
      contents: string;
    }[];
    declare args: any;
    declare self: any;
    ...
    constructor(contextData) {
      ...
      objectDefineProperties(this, {
        ...
        name: {
          value:
            typeof context.macro._ALIAS_OF === 'undefined'
              ? context.name
    ...
    addShadow(...names) {
      ...
      names.flat(Infinity).forEach((name) => {
        if (typeof name !== 'string') {
          throw new TypeError(
            `variable name must be a string; type: ${typeof name}`
          );
        }
