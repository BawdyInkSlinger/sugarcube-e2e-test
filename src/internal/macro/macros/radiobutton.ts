...
***********************************************************************************************************************/
/* global Macro, State, BisTempState.TempState, createSlug */
...
Macro.add('radiobutton', {
	...
	handler() {
		...
		*/
		if (!Object.hasOwn(TempStateContainer.TempState, this.name)) {
			TempStateContainer.TempState[this.name] = {};
		}

		if (!Object.hasOwn(TempStateContainer.TempState[this.name], varId)) {
