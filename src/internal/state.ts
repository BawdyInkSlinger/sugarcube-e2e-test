...
export const State = (() => { // eslint-disable-line no-unused-vars, no-var
  type History = ReturnType<typeof momentCreate> & { pull?: any};
	...
	let _temporary: SugarCubeTemporaryVariables = Object.create(null);
	...
	*/
	function stateRestore() {
		...
		const state = SessionContainer.session.get('state');
	...
	*/
	function momentCreate(title?: string, variables?: SugarCubeStoryVariables): {title: string, variables: SugarCubeStoryVariables} {
		return {
	...
	*/
	function historyDeltaEncode(historyArr): any[] | null {
	...
	*/
	function tempVariablesClear() {
		...
		/* legacy */
		TempVariablesContainer.TempVariables = _temporary; // eslint-disable-line no-undef
		/* /legacy */
	}
	...
	*******************************************************************************/
	...
	return Object.preventExtensions(objectCreateNull(null, {
		...
		// PRNG Functions.
		prng : {
			value : Object.preventExtensions(objectCreateNull(null, {
				init      : { value : prngInit },
