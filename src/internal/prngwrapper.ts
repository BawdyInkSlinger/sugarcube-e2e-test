...
export const PRNGWrapper = (() => { // eslint-disable-line no-unused-vars, no-var
	'use strict';
		...
		static unmarshal(prngObj) {
			...
			*/
			...
			for (let i = prngObj.pull; i > 0; --i) {
				(prng as { random: () => unknown } /* BIS: I probably have to do this because this code was written in error */).random();
			}
