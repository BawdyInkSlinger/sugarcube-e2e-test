...
export const Wikifier = (() => {
  ...
  class Wikifier {
    ...
    static createInternalLink(
      destination: OutputDestination | JQuery,
      passage: string,
      text: string,
      callback: () => void
    ): HTMLAnchorElement {
  ...
  Object.defineProperty(Wikifier, 'Parser', {
    value: (() => {
      ...
      function profilesHas(profile) {
        return (
          typeof _profiles === 'object' && _profiles.hasOwnProperty(profile)
        );
      }
    ...
    parseSquareBracketedMarkup: {
      value: (() => {
        ...
        const Delim = Lexer.enumFromNames([
          // delimiter state object (pseudo-enumeration)
