...
export type SaveHandler = (save: SaveObject, details: SaveDetails) => void;
export type LoadHandler = (save: SaveObject) => void;

export interface SaveEventAPI<HandlerType extends SaveHandler | LoadHandler> {
    /**
     * Add new handler
     * @param handler
     */
