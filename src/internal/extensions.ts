      ...
      Object.defineProperty(Array.prototype, 'flat', {
        ...
        value: (() => {
          function flat(/* depth */) {
            ...
            const depth =
              arguments.length === 0 ? 1 : Number(arguments[0]) || 0;
	...
	*/
    if (!Object.fromEntries) {
      Object.defineProperty(Object, 'fromEntries', {
        ...
        value(iter) {
          return Array.from(iter).reduce((acc: any, pair) => {
            if (Object(pair) !== pair) {
              throw new TypeError(
    ...
    if (!Object.getOwnPropertyDescriptors) {
      Object.defineProperty(Object, 'getOwnPropertyDescriptors', {
        ...
        value(obj) {
          ...
          return Reflect.ownKeys(O).reduce((acc, key) => {
...
*/
  (() => {
	...
	*/
    // params added by BIS. Original was ()
    function _random(
      monsterGirlFarmerMin: number,
      monsterGirlFarmerMax: number /* [min ,] max */
    ) {
      let min;
      let max;
