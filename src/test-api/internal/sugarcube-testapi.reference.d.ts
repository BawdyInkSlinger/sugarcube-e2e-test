...
/**
 * This file is EXCLUDED from the project. It is only a helpful reference.
 */

declare module 'sugarcubetestapi' {
  global {
    ...
    interface RequestLogger extends RequestHook {
       ...
       */
      contains(
        predicate: (request: LoggedRequest) => boolean
      ): Promise<boolean>;
      /**
    ...
    interface RequestMock {
      ...
      onRequestTo(
        filter:
          ...
          | RegExp
          | object
          | ((req: RequestMockOptions) => boolean)
      ): RequestMock;
      /**
    ...
    interface RoleFactory {
      (
        url: string,
        fn: (t: TestController) => Promise<any>,
        options?: RoleOptions
      ): Role;
      /**
    ...
    interface TestControllerPromise<T = any>
    ...
    type SkipJsErrorsCallback = (opts?: {
      message: string;
      stack: string;
      pageUrl: string;
    }) => boolean;
    ...
    interface Runner {
       ...
       */
      reporter(
        name: ReporterDescriptor['name'],
        output?: ReporterDescriptor['output']
      ): this;
       ...
       */
      startApp(
        command: AppOptions['command'],
        initDelay?: AppOptions['initDelay']
      ): this;
      ...
      useProxy(
        ...
        bypassRules?: ProxyOptions['bypassRules']
      ): this;
